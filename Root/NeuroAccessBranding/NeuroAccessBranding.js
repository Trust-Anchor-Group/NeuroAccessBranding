function NeuroAccessBrandingHandler()
{
    const mauiColors = {
        aliceblue: "#F0F8FF",
        antiquewhite: "#FAEBD7",
    ...
    {
        // already hex
        if (mauiColorString.startsWith("#"))
        {
            if (mauiColorString.match(/^#?[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$/g))
                return mauiColorString
        } else // system color string
        {
            const hex = mauiColors[mauiColorString]
            return hex
        }
    }
